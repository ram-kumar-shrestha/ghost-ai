Prisma is already installed. Add the project data models, Primsa client singleton, and first migration.
...
- timestamps
- indexed on owner ID and creation date
...
Create `lib/prisma.ts` as a cached singleton Prisma client.

Brnch by `DATABASE_URL`:
...
- `lib/prisma.ts` exports one cache Prisma instance
